...
namespace ShopForHome.Api.Migrations
{
    ...
    [Migration("20250906074013_AddCorrectProductIds")]
    partial class AddCorrectProductIds
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ShopForHome.Api.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 6,
                            Category = "arts",
                            ImageUrl = "https://example.com/wallarts.jpg",
                            Name = "Wall Arts",
                            Price = 6000m,
                            Rating = 4.8m,
                            Stock = 500
            ...
            modelBuilder.Entity("ShopForHome.Api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FullName = "Admin User",
                            PasswordHash = "$2a$11$kRSSeaSYq0PGjB1MJ0.s2ubruIU5n5CsvKDhVZFV02z4rkvwPs1.O",
                            Role = "Admin"
                        });
                });
