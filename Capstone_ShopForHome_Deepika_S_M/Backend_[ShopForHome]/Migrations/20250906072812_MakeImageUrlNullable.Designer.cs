...
namespace ShopForHome.Api.Migrations
{
    ...
    [Migration("20250906072812_MakeImageUrlNullable")]
            ...
            modelBuilder.Entity("ShopForHome.Api.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 4,
                            Category = "cot",
                            ImageUrl = "https://example.com/cot.jpg",
                            Name = "modern cot",
                            Price = 25000m,
                            Rating = 4.6m,
                            Stock = 1000
            ...
            modelBuilder.Entity("ShopForHome.Api.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            FullName = "Admin User",
                            PasswordHash = "$2a$11$2YHeolsGh2jHY5aAPfqrSuRih3Q0mo/680/nBxge2tcop6v0whddO",
                            Role = "Admin"
                        });
                });
